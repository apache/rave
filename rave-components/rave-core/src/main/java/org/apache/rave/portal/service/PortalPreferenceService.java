...
public interface PortalPreferenceService {
    ...
    /**
     * Creates a Map of all {@link org.apache.rave.portal.model.JpaPortalPreference}'s using the preference key as key for the Map.Entry
     *
    ...
    /**
     * Gets a {@link org.apache.rave.portal.model.JpaPortalPreference} by its key
     *
    ...
    /**
     * Saves a {@link org.apache.rave.portal.model.JpaPortalPreference} with a single value.
    ...
    /**
     * Saves a {@link org.apache.rave.portal.model.JpaPortalPreference} with a List of values.
     * If a PortalPreference already exists with this key, its value(s) will be overwritten.
     *
