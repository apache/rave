...
/**
 */
public class MongoDbPageTemplateConverter implements HydratingModelConverter<PageTemplate, PageTemplateImpl> {
    @Autowired
    ...
    public void hydrate(PageTemplateImpl dehydrated) {
        ...
        for(PageTemplateRegion region : dehydrated.getPageTemplateRegions()) {
            ...
            for(PageTemplateWidget widget : region.getPageTemplateWidgets()) {
                MongoDbPageTemplateWidget mongoWidget = ((MongoDbPageTemplateWidget)widget);
