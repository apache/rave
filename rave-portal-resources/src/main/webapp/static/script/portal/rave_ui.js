...
define(["jquery", "underscore", "handlebars","./rave_portal", "core/rave_core", "./rave_backbone", "./rave_models", "core/rave_core", "./rave_templates", "core/rave_view_manager", "core/rave_widget", "./rave_context"],
    function($, _, Handlebars, ravePortal, core, raveBackbone, raveModels, raveCore, raveTemplates, raveViewManager, raveRegionWidget, raveContext){
    var exports = {};
    ...
    var App = raveBackbone.View.extend({
        ...
        initialize: function () {
            ...
            this.models.page.on('declineShare', function () {
                document.location.href = raveContext.getContext();
            });
        }
    });
    ...
    function showEmptyDisplay() {
        if (_.isEmpty(raveCore.getWidgets())) {
    ...
    function setupDragAndDrop() {
        ...
        function dragStart(event, ui) {
            ...
            uiState.widget = raveCore.getWidget(ravePortal.getObjectIdFromDomId(widgetEl.id));
    ...
    function registerHomeView() {
        ...
        HomeView.prototype.render = function (widget) {
            ...
            function aboutWidget() {
                ravePortal.viewWidgetDetail(widgetId, getCurrentPageId());
                return false;
            }

            function commentOnWidget() {
                ravePortal.viewWidgetDetail(widgetId, getCurrentPageId(), 'widgetComments');
                return false;
            }

            function rateWidget() {
                ravePortal.viewWidgetDetail(widgetId, getCurrentPageId(), 'widgetRatings');
                return false;
            }
        ...
        raveViewManager.registerView('home', HomeView);
    }
    ...
    function registerCanvasView() {
        ...
        raveViewManager.registerView('canvas', CanvasView);
    }
    ...
    function registerPopups() {
        ...
        _.each(POPUPS, function (target) {
            ...
            raveViewManager.registerView(target.name, {
    ...
    core.registerOnInitHandler(init);
