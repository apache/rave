define(['app', 'core/rave_core', 'angularUi', 'angularBootstrap'], function (app, rave) {
    app.requires.push('ui.bootstrap', 'ui');

    app.config(['$dialogProvider',
        ...
        .controller('PortalController', ['$scope', 'pages', '$routeParams', '$q', '$dialog',
            function ($scope, pages, $routeParams, $q, $dialog) {
                $scope.user;
                $scope.portalPrefs;
                $scope.pages = pages;
...
//            }
//        ])
//        .controller('WidgetController', ['$scope', 'Pages',
