...
/**
 * a String that has been internationalized into several Locales. This class is used as a replacement for the String type whenever a 
 * String  needs to be i18nn-capable. An instance of the InternationalString interface composes within it an ArrayList of LocalizedString instances, 
...
public class InternationalString {
	...
	/**
	 * The collection of localized strings representing the different
	 * versions of the string for particular language-tags.
	 */
	private ArrayList<LocalizedString> localizedStrings;
	
	
	public LocalizedString getDefaultLocalizedString(){
		return LocalizationUtils.getLocalizedElement(this.localizedStrings.toArray(new LocalizedString[this.localizedStrings.size()]), null);		
	}
	...
	public LocalizedString getLocalizedString(String[] locales){
		return LocalizationUtils.getLocalizedElement(this.localizedStrings.toArray(new LocalizedString[this.localizedStrings.size()]), locales);
	}
